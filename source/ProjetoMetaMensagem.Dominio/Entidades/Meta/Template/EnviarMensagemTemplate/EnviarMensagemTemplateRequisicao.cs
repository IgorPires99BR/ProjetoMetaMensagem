...
namespace ProjetoMetaMensagem.Dominio.Entidades.Meta.Template.EnviarMensagemTemplate
{
    public class EnviarMensagemTemplateRequisicao
    {
        public EnviarMensagemTemplateRequisicao(EnviarMensagemTemplateMetaCommand command)
        {
            ...
            {
                this.Template.Componentes.Add(new ComponenteEnvio
                {
                    Tipo = "body",
