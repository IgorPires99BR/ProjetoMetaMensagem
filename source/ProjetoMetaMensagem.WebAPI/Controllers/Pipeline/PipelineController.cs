...
using ProjetoMetaMensagem.Dominio.UseCases.Pipeline.AlteraPipeline;
using ProjetoMetaMensagem.Dominio.UseCases.Pipeline.CriaPipeline;
using ProjetoMetaMensagem.Dominio.UseCases.Pipeline.DeletaPipeline;
using ProjetoMetaMensagem.Dominio.UseCases.Pipeline.ListaPipeline;
using ProjetoMetaMensagem.Dominio.UseCases.Pipeline.ObtemPipelineComEtapas;
using ProjetoMetaMensagem.Dominio.UseCases.PipelineEtapa.AlteraEtapa;
using ProjetoMetaMensagem.Dominio.UseCases.PipelineEtapa.CriaEtapa;
using ProjetoMetaMensagem.Dominio.UseCases.PipelineEtapa.DeletaEtapa;
using ProjetoMetaMensagem.Dominio.UseCases.PipelineEtapa.ListaEtapa;
