...
namespace ProjetoMetaMensagem.Servico.Meta.CriarTemplate
{
    public class CreateTemplateRequest
    {
        public CreateTemplateRequest(CreateTemplateRequisicao entidade)
        {
            ...
            this.Name = entidade.Nome;
            this.Language = entidade.Idioma;
            this.Category = entidade.Categoria;

            if (entidade.Componentes != null)
            {
                this.Components = entidade.Componentes.Select(c => new TemplateComponent
                {
                    Type = c.Tipo,
                    Format = c.Formato,
                    Text = c.Texto,
